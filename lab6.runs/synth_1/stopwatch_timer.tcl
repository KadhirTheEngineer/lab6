...
namespace eval ::optrace {
  variable script "D:/School/2024-2025/digi logic/lab6/lab6.runs/synth_1/stopwatch_timer.tcl"
...
synth_design -top stopwatch_timer -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef stopwatch_timer.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file stopwatch_timer_utilization_synth.rpt -pb stopwatch_timer_utilization_synth.pb"  } 
